module ActiveMerchant
  module Billing
    class TwoCheckoutGateway < Gateway
      self.test_url = 'https://sandbox.2checkout.com/checkout/purchase'
      self.live_url = 'https://2checkout.com/checkout/purchase'

      self.supported_countries = %w(PK US)
      self.default_currency = 'USD'
      self.supported_cardtypes = [:visa, :master, :american_express, :discover, :jcb, :diners_club]

      self.homepage_url = 'http://localhost:3000/'
      self.display_name = 'Two Checkout'
